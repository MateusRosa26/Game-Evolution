...
export const SKILL_META: Record<string, SkillMeta> = {
  golpe_forte: { name: "Golpe Forte", glyph: "GF", color: 0xc9c2b0, target: "enemy" },
  bola_de_fogo: { name: "Bola de Fogo", glyph: "BF", color: 0xff7a32, target: "enemy" },
  lanca_de_gelo: { name: "Lança de Gelo", glyph: "LG", color: 0x6fc8e8, target: "enemy" },
  apunhalar: { name: "Apunhalar", glyph: "AP", color: 0xb86fd0, target: "enemy" },
  luz_sagrada: { name: "Luz Sagrada", glyph: "LS", color: 0xf2e08a, target: "enemy" },
