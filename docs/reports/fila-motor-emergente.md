...
- **NÚMEROS CALIBRADOS — Chat C (bateria `2026-06-11-bateria-marcas-lote1-tipo1.md`):** tipo-1 (①②④) com número final (✅ **4 valores CONFIRMADOS pelo criador 2026-06-12** — não mais ✏️; Chat A aplica ② 1.20→1.12 + viaWeapon):
