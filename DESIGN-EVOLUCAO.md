...
- [~] **Curva de XP migrada + SCALE pinado** (2026-06-11, lei de potência `175·(n−1)^2.5`, re-pinada pela bateria de farm-loop: ~35h eficientes) — fecha o "fator da curva". FALTA: (a) re-ancorar o XP/h **late (15→25)** com mobs T2/T3 (hoje extrapolado); (b) **confirmar DEATH_XP_PENALTY**: a 10%, a morte custa **39%→99% do custo do nível** (quase 1 nível no late; doc estimava ~20% pressupondo geométrica) — no cap ≈ 3,1h. Knob visceral ✏️ criador: manter 10% (brutal) ou ~7-8%. Punições secundárias leves (gold? debuff?) ✏️
